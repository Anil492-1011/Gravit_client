...
const ToastTitleAndDescription = ({ title, description, ...props }) => (
  <div className="grid gap-1">
    {title && <ToastTitle {...props}>{title}</ToastTitle>}
    {description && <ToastDescription {...props}>{description}</ToastDescription>}
  </div>
)
